    ...
    <section class="add-product-container">
        <div class="add-product-wrapper">
            <header class="add-product-header">
                <h1 class="add-product-title">Add New Service</h1>
            ...
            <form class="add-product-form">
                ...
                <div class="add-product-input-wrapper">
                    <label for="productName" class="add-product-input-label">Service Name</label>
                    <input type="text" id="productName" class="add-product-input" placeholder="VD: Dịch vụ thuê phòng"
                        required />
                </div>
            </form>

            <h2 class="add-product-description-title">Service Description</h2>
