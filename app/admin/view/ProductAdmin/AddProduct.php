        ...
        <div class="add-product-wrapper">
            ...
            <form class="add-product-form">
                ...
                <div class="add-product-input-wrapper">
                    ...
                    <input type="text" id="productName" class="add-product-input" placeholder="VD: Four Seasons Studio"
                        required />
                </div>
            </form>
            ...
            <div class="add-product-editor">
                ...
                <div class="add-product-section">
                    <h3 class="add-product-section-heading">Section 1</h3>
                ...
                <div class="add-product-section">
                    <h3 class="add-product-section-heading">Section 2</h3>
                    <div class="add-product-content">
                        <label for="section2Title" class="add-product-content-label">Title:</label>
                        <input type="text" id="section2Title" class="add-product-content-input" required />
                        <label for="section2Desc" class="add-product-content-label">Description:</label>
                        <textarea id="section2Desc" class="add-product-content-textarea" required></textarea>
                    </div>
                </div>

                <div class="add-product-section">
                    <h3 class="add-product-section-heading">Section 3</h3>
                    <div class="add-product-content">
                        <label for="section3Title" class="add-product-content-label">Title:</label>
                        <input type="text" id="section3Title" class="add-product-content-input" required />
                        <label for="section3Desc" class="add-product-content-label">Description:</label>
                        <textarea id="section3Desc" class="add-product-content-textarea" required></textarea>
                    </div>
                </div>
            </div>
        </div>
